package com.ikutakao.ikutakao.TDXApi;
...
public class TDXApi {
    ...
    // "XXXXXXXXXX-XXXXXXXX-XXXX-XXXX")); //your clientId
    // params.add(new BasicNameValuePair("client_secret",
    // "XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX")); //your clientSecret
    ...
    // private static String getJsonString(String tdxUrl, Map<String, String>
